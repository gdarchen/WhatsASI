...
\begin{itemize}
\item \textbf{1 humain : } l'utilisateur dialoguera avec un(des) personnage(s) virtuel(s) pour lesquels une IA\footnote{Intelligence Artificielle} minimaliste aura été développée ;
\item \textbf{2 humains ou plus : } les utilisateurs communiqueront ensemble selon les deux types de dialogue : messages écrits ou visio- ou audio-conférence.
\end{itemize}
\vskip \baselineskip
